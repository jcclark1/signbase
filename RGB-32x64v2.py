...
def parseGoogleNews():
  ...
  #print("-"*60)
			# headlines.append(news.title.text)
        		headlines.append([randomColor(), cleanupUnicode(news.title.text)])
...
def newTopList(): 
  ...
  #bottomList.append([randomColor(), timeMessage()])
  #bottomList.append([randomColor(), dateMessage()])
...
#      thread.start_new_thread(getHeadlines, ())
      thread.start_new_thread(parseGoogleNews, ())
    except:
